            ...
            <>
              ...
              <div className="col-lg-3 col-md-6 box2">
                {data[selectedApis.box2] && (
                  <div className="team-cart">
                    ...
                    <div className="text-wraper">
                      ...
                      <div className="name-wraper">
                        <Flag
                          code={data[
                            selectedApis.box2
                          ].data.data.rider_country.toUpperCase()}
                          style={{
                            width: "20px",
                            height: "20px",
                            marginRight: "10px",
                    ...
                    <h5>
                      <strong>
                        {data[selectedApis.box2].data.data.weight}
                      </strong>{" "}
                      Kilogram
                    </h5>
                    ...
                    .map((rider, index) => (
                      <div className="team-cart" key={index}>
                        ...
                        {rider.second_place_count && (
                          <h5>
                            <strong>{rider.second_place_count}</strong>count
                          </h5>
                        )}
                  ...
                  data[selectedApis.box4].data.data
                    ...
                    .map((rider, index) => (
                      <div className="team-cart" key={index}>
                        ...
                        {rider.top5_count && (
                          <h5>
                            <strong>{rider.top5_count}</strong>count
                          </h5>
                        )}
                        <a href="#?" className="green-circle-btn">
                          <img src="/images/arow.svg" alt="" />
              ...
              <div className="col-lg-7 box5">
                <div className="row">
                    ...
                    {data[selectedApis.box5Race] && (
                      <div className="races">
                        <h5>
                          ...
                          <strong>
                            {data[selectedApis.box5Race].data.count}
                          </strong>
                        </h5>
                      </div>
                    )}
                  ...
                  <div className="col-lg-7 col-md-6">
                    {data[selectedApis.box5Consistent] &&
                      data[selectedApis.box5Consistent].data.data
                        .slice(0, 1)
                        .map((rider, index) => (
                          <div
                          ...
                          >
                            ...
                            {selectedApis.box5Consistent === "gcPodiums" &&
                              rider.count && (
                                <h5>
