...
import { ErrorMessage, ErrorStats, LoadingStats } from "@/components/loading&error";
import { useMultipleData } from "../../home_api_data";


const Mostparticipants = ({
    ...
    const getBoxData = (key) => {
        ...
        const paths = [
            response?.data?.rider_participation,
            response,
        ];
                                ...
                                {(() => {
                                    ...
                                    return (
                                        ...
                                        <div className="win-count">
                                            {riderData.participations && <span>{riderData.participations}</span>}
