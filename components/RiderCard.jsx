...
export default function RiderCard({ name, team, flag, riderId, riderSlug }) {
  ...
  return (
    <li className="hoverState-li custom-list-el ss">
      ...
      <h6 className="team-name"> <Link
        ...
        className="link"
      >{team}</Link></h6>
      <a href={`/riders/${riderSlug}`} className="r-details d-none">
